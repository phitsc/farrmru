...
enum E_EntryTypeT { E_EntryType_UNKNOWN=0, E_EntryType_FILE=1, E_EntryType_FOLDER=2, E_EntryType_ALIAS=3, E_EntryType_URL=4  , E_EntryType_PLUGIN=5, E_EntryType_CLIP=5, E_EntryType_ALIASFILE=7, E_EntryType_dummybig=79000};
//---------------------------------------------------------------------------
